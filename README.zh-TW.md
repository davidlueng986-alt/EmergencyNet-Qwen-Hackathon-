...
EmergencyNet 能夠幫助災難救援隊在現場網路服務薄弱或中斷的情況下，提高分流效率和指揮協調能力。其目標非常實際：幫助小型救援隊減少資訊遺漏，透過無線電傳輸少量結構化數據，並為指揮官提供更清晰的態勢感知。

救援人員在 Android 平板輸入一名傷患的狀況。平板在本機執行固定的START Triage Algorithm ，給出 BLACK、RED、YELLOW 或 GREEN 檢傷標籤。系統同時檢查八種容易在壓力下漏掉的風險，例如面部燒傷後延遲出現的呼吸道問題，或長時間受困後可能出現的併發風險。
